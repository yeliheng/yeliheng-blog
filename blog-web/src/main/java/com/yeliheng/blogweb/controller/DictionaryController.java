...
public class DictionaryController {
    ...
    @Log(moduleName = "添加字典",operateType = OperateType.INSERT)
    ...
    @Log(moduleName = "删除字典",operateType = OperateType.DELETE)
    ...
    @Log(moduleName = "修改字典",operateType = OperateType.INSERT)

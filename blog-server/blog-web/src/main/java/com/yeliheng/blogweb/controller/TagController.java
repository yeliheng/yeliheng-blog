...
public class TagController {
    ...
    @Log(moduleName = "添加标签",operateType = OperateType.INSERT)
    ...
    @Log(moduleName = "删除标签",operateType = OperateType.DELETE)
    ...
    @Log(moduleName = "修改标签",operateType = OperateType.UPDATE)
